        ...
        <form action={formAction} className="border border-gray-300 rounded-xl shadow-md p-4">
            <fieldset className="fieldset space-y-2">
                ...
                <div className="flex flex-col space-y-1">
                    ...
                    <input type="text" id="titleInput" name="title" placeholder="Note title..." className="input border-gray-200 focus:ring-0 focus:outline-none focus:border-gray-500 transition-colors duration-200 w-full rounded-lg" />
                ...
                <div className="flex flex-col space-y-1">
                    ...
                    <input type="text" id="tagsInput" name="tags" placeholder="Add a tag..." className="input  border-gray-200 focus:ring-0 focus:outline-none focus:border-gray-500 transition-colors duration-200 w-full rounded-lg" />
                    <p className="text-sm text-gray-400">Separate tags with spaces e.g. &quot; <span className="italic">food</span> <span className="italic">web-dev</span> <span className="italic">games</span> &quot;</p>
                ...
                <div className="flex flex-col space-y-1">
                    ...
                    <textarea
                        ...
                        className="input  border-gray-200 focus:ring-0 focus:outline-none focus:border-gray-500 transition-colors duration-200 w-full rounded-lg h-[40dvh] text-wrap pt-1"
                    />
